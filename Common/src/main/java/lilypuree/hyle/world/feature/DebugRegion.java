...
public class DebugRegion {
    ...
    public static StoneRegion EMPTY_REGION = getEmpty();

    private static StoneRegion getEmpty() {
        return new StoneRegion(
                new PrimaryNoiseSampler.Settings(StoneType.NO_REPLACE, List.of(StoneType.NO_REPLACE), StoneType.NO_REPLACE, StoneType.NO_REPLACE, -0.875f, 0.875f, 0.875f, 0),
                new SecondaryNoiseSampler.Settings(List.of(StoneType.NO_REPLACE), StoneType.NO_REPLACE, StoneType.NO_REPLACE, 50, 100),
                List.of(StoneType.NO_REPLACE), 0.99f, 0);
    }
